        ...
        <div class="home-carousel-side">
          <a href="show/53606" id="love">
            ...
            <div class="home-carousel-texts">
                ...
                <p class="home-carousel-a-genre">{{ $t('home.comedy') }}</p>
            </div>
          </a>
        </div>
        <div class="home-carousel-side home-carousel-gradient">
          <a href="show/62560" id="mrRobot">
            ...
            <div class="home-carousel-texts">
                ...
                <p class="home-carousel-b-genre">{{ $t('home.crime') }}</p>
            </div>
          </a>
        </div>
        <div class="home-carousel-middle home-carousel-gradient">
          <a href="show/19885" id="sherlock">
            ...
            <div class="home-carousel-texts">
                ...
                <p class="home-carousel-c-genre">{{ $t('home.crime') }}</p>
            </div>
          </a>
        </div>
        <div class="home-carousel-side home-carousel-gradient">
          <a href="show/63247" id="westworld">
            ...
            <div class="home-carousel-texts">
                ...
                <p class="home-carousel-d-genre">{{ $t('home.western') }}</p>
            </div>
          </a>
        </div>
        <div class="home-carousel-side home-carousel-gradient">
          <a href="show/60622" id="fargo">
            ...
            <div class="home-carousel-texts">
                ...
                <p class="home-carousel-e-genre">{{ $t('home.drama') }}</p>
            </div>
          </a>
        </div>
      ...
      <div class="home-last-tvshows-aired-critics">
        <div class="home-last-tvshows-title">
          <div id="home-last-tvshows-text">
            <img src="~assets/lastEpisodes.png" id="home-last-tvshows-icon"/> {{ $t('home.lastEp') }}
          </div>
        </div>
        ...
        <div class="home-last-tvshows-critics">
          <div class="home-last-tvshows-critics-title">
            <div id="home-last-tvshows-critics-text">
              {{ $t('home.lastCr') }} <img src="~assets/critics.png" id="home-last-tvshows-critics-icon"/>
            </div>
          </div>
            ...
            <div class="home-last-tvshows-critics-gradient">
              <div class="home-last-tvshows-critics-element"></div>
                <div class="pouet">
                  ...
                  <p class="home-last-tvshows-critics-user">{{ $t('show.by') }} {{criticUser1}}</p>
              ...
              <div class="pouet2">
                  ...
                  <p class="home-last-tvshows-critics-user">{{ $t('show.by') }} {{criticUser2}}</p>
      ...
      <div class="home-new-tvshows">
        <div class="home-new-tvshows-title">
          <div id="home-new-tvshows-text">
            <img src="~assets/about.png" id="home-new-tvshows-icon"/> {{ $t('home.lastsh') }}
          </div>
        </div>
        ...
        <div class="home-new-tvshows-element-side">
          <a href="show/66310" id="love">
            ...
            <div class="home-carousel-texts">
                ...
                <p class="home-carousel-a-genre">{{ $t('home.crime') }}</p>
            </div>
          </a>
        </div>
        ...
        <div class="home-new-tvshows-element-middle">
          <a href="show/70134" id="love">
            ...
            <div class="home-carousel-texts">
                ...
                <p class="home-carousel-a-genre">{{ $t('home.drama') }}</p>
            </div>
          </a>
        </div>
        ...
        <div class="home-new-tvshows-element-side">
          <a href="show/54344" id="love">
            ...
            <div class="home-carousel-texts">
                ...
                <p class="home-carousel-a-genre">{{ $t('home.scifi') }}</p>
            </div>
          </a>
        </div>
      </div>
...
export default {
  ...
  head () {
    return {
      lastEp: this.$t('home.lastEp'),
      lastCr: this.$t('home.lastCr'),
      comedy: this.$t('home.comedy'),
      crime: this.$t('home.crime'),
      western: this.$t('home.western'),
      drama: this.$t('home.drama'),
      scifi: this.$t('home.scifi'),
      lastsh: this.$t('home.lastsh'),
      by: this.$t('show.by'),
    }
  },
