      ...
      <div class="backdrop-gradient">
        <div class="backdrop">
          ...
          <div class="tvshow-title">
            ...
            <p id="tvshow-number-seasons">{{movie.number_of_seasons}} {{ $t('show.seasons') }}</p>
            <p id="tvshow-last-air-date">{{ $t('show.lastEpAi') }} {{movie.last_air_date}}</p>
            <div>
      ...
      <div class="tvshow-synopsis-cast">
        <div class="tvshow-synopsis">
          <div id="tvshow-about-text">
            <img src="~assets/about.png" id="tvshow-about-icon"/> {{ $t('show.aboutSh') }}
          </div>
          <p id="tvshow-followers">254 {{ $t('show.followers') }}</p>
          <p id="tvshow-critics">26 {{ $t('show.critics') }}</p>
        ...
        <div class="tvshow-cast">
          <div id="tvshow-cast-text">
            {{ $t('show.cast') }} <img src="~assets/cast.png" id="tvshow-cast-icon"/>
          </div>
        ...
        <div  class="tvshow-seasons-episodes">
          <ul>
            <li  id="tvshow-season-list" v-for="(season, index) in movie.seasons">
              <div  class="tvshow-season-img"><p  id="tvshow-season-text">{{ $t('show.season') }} {{season.season_number}} {{season.episode_count}} episodes</p><img  :src="img_path + season.poster_path" id="tvshow-season-poster"/></div>
              <ul>
...
export default {
  data: () => ({
    ...
    season_: 'season',
    episodes: 'episodes',
    lastEpAi: 'Last episode aired',
    aboutSh: 'About the show',
    followers: 'Followers',
    cast_: 'The cast'
  }),
  props: [
  ...
  head () {
    return {
      seasons: this.$t('show.seasons'),
      season_: this.$t('show.season'),
      episodes: this.$t('show.episodes'),
      lastEpAi: this.$t('show.lastEpAi'),
      aboutSh: this.$t('show.aboutSh'),
      followers: this.$t('show.followers'),
      cast_: this.$t('show.cast')
    }
  }
